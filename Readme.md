...
|        | Windows 7/8/10 | Windows 10 | Webpage | Android |
|--------|----------------|------------|---------|-------|
| Type |  Portable exe | Store app | Javascript | Play Store | Desktop applications |
| Description | Download rar, extract exe file and execute it. There is no installation. | Download it directly from the Microsoft store | Javascript file to implement it on your webpage | Bring the sheep with you on your phone |
...
<a href='https://github.com/RedSparr0w'>RedSparr0w</a> for the minecraft tools and spritesheet generator<br>
Michelle for the cats animations<br>
